  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook') => {
    try {
      ...
      if (data.success && data.url) {
        ...
        toast.error(`${provider === 'google' ? 'Google' : 'Facebook'} login not configured. Contact admin.`);
      }
    } catch {
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors disabled:opacity-50"
              >
